...
$(document).ready(() => {
  const links = [
    ...
    {
      name: 'Roblox',
      link: 'roblox.com/users/61504490/profile/',
    },
    {
      name: 'Youtube',
      link: 'https://www.youtube.com/channel/UCct_8UeJcMu34AWi42r2Kxw',
    },
    {
      name: 'Steam',
      link: 'https://steamcommunity.com/profiles/76561198104161018',
    },
    {
      name: 'Crackland',
      link: 'Crackland.club',
  ...
  app.titleChanger(['Crackhead', 'Depresed', 'Anime', 'Sm00thBrain','gamer',''])
...
$.getJSON(ipgeolocation, (data) => {
  writeLine(['Checking your ip to make sure your a real crack head', "No smart brain detected redirecting! Redirecting <span style='font-size: 14px; color: #06d;'>[Success]</span>..."], 10, () => {
    ...
    writeLine([`Hey crackhead! <span style='font-size: 14px; color: #0f0;'>[success]</span>`, `We have checked, <i style='color: #0f0'>${ip}</i>! also we detected you live in ${country} here!`], 30, 30, () => {
      if (app.skippedIntro) return;
